        ...
        <section className="h-full flex flex-col justify-between">
            ...
            <div className="flex font-josefin font-bold">
                ...
                <div className="mx-auto">
                    ...
                    <input onChange={e => setNumOne(e.target.value)} onKeyDown={handleKeyDown} className="text-black text-lg rounded-lg border-0 w-[230px] min-[375px]:w-[300px] sm:w-[400px]" type="text" id="input" maxLength="10" placeholder="Must be a whole integer" required/>
                </div>
                <div className="mx-auto hidden xl:block">
